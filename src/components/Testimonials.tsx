  ...
  return <section className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600">Conheça alguns de nossos revendedores de sucesso</p>
        </div>

        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {testimonials.map(testimonial => <Card key={testimonial.id} className="h-full hover:shadow-lg transition-shadow">
