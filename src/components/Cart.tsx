...
const Cart = () => {
  ...
  if (items.length === 0) {
    return (
      <section id="carrinho" className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center">
            <h2 className="text-3xl font-bold mb-4">Seu Carrinho</h2>
            <p className="text-gray-600 mb-8">Seu carrinho está vazio. Adicione produtos do catálogo.</p>
            <Button 
  ...
  return (
    <section id="carrinho" className="py-20 bg-gray-50">
      <div className="container mx-auto px-4">
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex items-center space-x-2">
                      <Button
                        variant="outline"
                        size="sm"
                        onClick={() => updateQuantity(item.id, Math.max(3, item.quantity - 1))}
