        ...
        <section className="bg-ink text-ink-foreground">
          <div className="responsive-container py-6 sm:py-8">
            ...
            <p className="mt-3 max-w-3xl text-sm leading-relaxed text-ink-foreground/80 sm:text-base">
              Informe quanto gasta com corridas por app e sua rotina. A comparação com até duas bikes reais aparece na
              hora, sem cadastro.
            </p>
          </div>
        </section>
            ...
            <div className="rounded-lg bg-card p-5 ring-1 ring-line sm:p-6">
              ...
              <div className="mt-6 space-y-5">
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <NumberField
                    name="dailyKm"
                    label="Km por dia dessas corridas"
                    help="Ida + volta, somando só as corridas que faria de bike."
                    value={dailyKm}
                    onChange={setDailyKm}
                  ...
                  <NumberField
                    name="daysPerWeek"
                    label="Dias por semana dessas corridas"
                    value={daysPerWeek}
            ...
            >
              ...
              {!data ? (
                ...
                <div className="mt-5 space-y-5">
                  <ResultHero
                    eyebrow="Uber/99 ou bike no seu trajeto"
                    value={brl(Math.abs(data.monthlySavings), true)}
                    favorable={data.monthlySavings > 0}
                    conclusion={
                      data.monthlySavings > 0
                        ? "de economia mensal estimada ao substituir as corridas informadas. O preço de compra de cada bike entra na projeção abaixo."
                        : data.monthlySavings < 0
                          ? "de custo mensal adicional estimado com a bike. Veja a projeção completa antes de decidir."
                          : "de diferença mensal com os dados informados."
                    }
                  />
                  ...
                  <p className="text-xs leading-relaxed text-muted-foreground">
                    Estimativa operacional, sem incluir o preço da bike: custo estimado da bike{" "}
                    {brl(data.bikeTotalCost, true)}/mês. O preço real entra no gráfico e nos cards.
                  </p>
                  ...
                  <div className="mt-6 grid gap-5 lg:grid-cols-2">
                    {paybacks.map(({ bike, projection }) => (
                      <BikeResultCard
                        ...
                        position="calculadora_uber_vs_bike"
                      />
                    ))}
                  </div>
                  <div className="mt-5">
            ...
            <div className="mt-5 grid gap-6 text-sm leading-relaxed text-muted-foreground lg:grid-cols-2">
              <div>
                ...
                <ul className="mt-2 list-disc space-y-2 pl-5">
                  <li>
                    Você informa só o gasto, km e dias das corridas que faria de bike; esse conjunto inteiro é
                    considerado substituído. Nada é presumido sobre suas outras corridas.
                  </li>
              ...
              <div>
                ...
                <ul className="mt-2 list-disc space-y-2 pl-5">
                  ...
                  <li>
                    Tarifa dinâmica, gorjetas e variação de preço dos apps não são modeladas; usamos só o gasto que você
                    informou.
                  </li>
                </ul>
              </div>
