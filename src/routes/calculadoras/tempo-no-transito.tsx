...
function TempoNoTransito() {
  ...
  const errors = {
    currentMinutes: validateNumber(currentMinutes, "Tempo hoje", LIMITS.minutesPerDay),
            ...
            <div className="rounded-lg bg-card p-5 ring-1 ring-line sm:p-6">
              ...
              <div className="mt-6 space-y-5">
                <div className="grid gap-4 sm:grid-cols-2">
                  <NumberField name="currentMinutes" label="Minutos por dia hoje" value={currentMinutes} onChange={setCurrentMinutes} onBlur={() => mark("currentMinutes")} suffix="min" step="1" help="Ida + volta, incluindo espera." error={err("currentMinutes")} />
                  <NumberField name="bikeMinutes" label="Minutos por dia de bike" value={bikeMinutes} onChange={setBikeMinutes} onBlur={() => mark("bikeMinutes")} suffix="min" step="1" help="Sua estimativa para os mesmos trajetos, ida + volta." error={err("bikeMinutes")} />
                </div>
                <div className="grid gap-4 sm:grid-cols-2">
