        ...
        <section className="bg-ink text-ink-foreground">
          <div className="responsive-container py-6 sm:py-8">
            ...
            <p className="mt-3 max-w-3xl text-sm leading-relaxed text-ink-foreground/80 sm:text-base">
              Informe o gasto e a distância só dos trajetos que faria de bike. O prazo de retorno de até duas bikes
              reais aparece na hora, sem cadastro.
            </p>
          </div>
        </section>
            ...
            >
              ...
              {!data ? (
                ...
                <div className="mt-5 space-y-5">
                  <ResultHero
                    eyebrow="Quando o investimento pode se pagar"
                    value={selectedBike ? paybackLabel : "Escolha uma bike"}
                    favorable={data.monthlySavings > 0 && selectedBike !== null}
                    conclusion={
                      selectedBike
                        ? data.monthlySavings > 0
                          ? `Estimativa para ${selectedBike.name}, considerando a oferta atual e a economia mensal calculada. Troque de bike abaixo para comparar o prazo.`
                          : "Neste cenário não há economia mensal positiva; o investimento não se paga pelos gastos informados."
                        : "Informe a distância e escolha uma oferta compatível para calcular o prazo de retorno."
                    }
                  />
                  ...
                  <p className="text-xs leading-relaxed text-muted-foreground">
                    Estimativa. Payback = preço atual da oferta ÷ economia mensal positiva, arredondado para cima em 0,1
                    mês.
                  </p>
            ...
            <div className="mt-5 grid gap-6 text-sm leading-relaxed text-muted-foreground lg:grid-cols-2">
              ...
              <div>
                ...
                <ul className="mt-2 list-disc space-y-2 pl-5">
                  ...
                  <li>
                    O gasto informado deve excluir seguro, IPVA e outros custos fixos de veículo que continuará sendo
                    mantido.
                  </li>
                </ul>
              </div>
