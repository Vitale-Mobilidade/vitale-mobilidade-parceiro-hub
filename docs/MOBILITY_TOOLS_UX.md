...
| 7 | `/calculadoras/moto-vs-bike` | Moto ou bike elétrica no trajeto? | gasto mensal variável evitável da moto (sem fixos), km/dia total antes da substituição, dias/sem, %, continuará com a moto? (sim/não), orçamento opcional, garupa (toggle); "Ajustar premissas" opcional com 1 campo de custo fixo evitado, só se "não" | até 2 | PREVIEW |
| 8 | `/calculadoras/tempo-no-transito` | Quanto tempo por ano passo no trânsito? | minutos/dia hoje (ida+volta), minutos/dia de bike (estimativa do usuário), dias/sem, km/dia (opcional, só para bikes); orçamento/garupa opcionais em detalhes; semanas/ano (52) editável só em "Como calculamos?"; sem payback nem custo | até 2 (com km/dia) | PREVIEW |
