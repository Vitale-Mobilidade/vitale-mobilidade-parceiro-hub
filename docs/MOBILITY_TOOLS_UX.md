...
| 5 | `/calculadoras/carro-vs-bike` | Carro ou bike: quanto cada um custa no trajeto? | gasto mensal evitável do carro, %, km/dia, dias/sem, mantém o veículo? (sim/não), orçamento (+garupa) | até 2 | PLANEJADA — sem link público |
